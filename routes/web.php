...
// Pasando un parámetro {nombre} ->obligatorio {nombre?} ->opcional
...
// name('login'), en caso de no etar autenticado retorna al login
Route::get('seguridad/login', 'Seguridad\LoginController@index')->name('login');
// Post porque se envía el formulario
...
Route::get('libro-prestamo', 'LibroPrestamoController@index')->name('libro-prestamo')->middleware('auth'); /* Mejor codificación */
...
/* No usables */
// Route::post('libro/{libro}', 'LibroPrestamoController@ver')->name('ver_libro')->middleware('auth');
// Route::get('libro/{id}/editar', 'LibroPrestamoController@editar')->name('editar_libro')->middleware('auth');
// Route::put('libro/{id}', 'LibroPrestamoController@actualizar')->name('actualizar_libro')->middleware('auth');
// Route::delete('libro/{id}', 'LibroPrestamoController@eliminar')->name('eliminar_libro')->middleware('auth');
